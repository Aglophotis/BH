...
void Colorhook::OnDraw() {
	...
	if (Colorhook::current == this) {
		...
		//Draw title
		Texthook::Draw(360, 186, false, 0, White, BH::translation->menu.color.choose.value);
		...
		//Draw instructions
		Texthook::Draw(320, 384, false, 0, White, BH::translation->menu.color.select.value);
		Texthook::Draw(320, 368, false, 0, White, BH::translation->menu.color.close.value);
	} else {
